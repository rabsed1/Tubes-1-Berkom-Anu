...
# CONFIG DATABASE
DB_STASIUN_ENT_MAKS = 100
DB_KARTU_ENT_MAKS = 100
...
daftar_stasiun_ID = ["" for _ in range(DB_STASIUN_ENT_MAKS)]
daftar_stasiun_NAMA = ["" for _ in range(DB_STASIUN_ENT_MAKS)]
daftar_stasiun_JARAK = [0 for _ in range(DB_STASIUN_ENT_MAKS)]
daftar_kartu_ID = ["" for _ in range(DB_KARTU_ENT_MAKS)]
daftar_kartu_NAMA = ["" for _ in range(DB_KARTU_ENT_MAKS)]
daftar_kartu_SALDO = [0 for _ in range(DB_KARTU_ENT_MAKS)]
jumlah_stasiun = 0
jumlah_kartu = 0

# INISIALISASI VARIABEL GLOBAL
indeks_kartu = 0
indeks_stasiun_awal = 0
indeks_stasiun_akhir = 0
indeks_stasiun_awal_rute = 0
indeks_stasiun_akhir_rute = 0
arah_kereta = ""
rute_kereta = ""
...
while True:
    ...
    input("Pencet apapun untuk kembali ke awal...")